<nav
	class="bg-white border-gray-200 px-2 sm:px-4 py-3 rounded dark:bg-gray-800 border-b fixed top-0 left-0 w-full right-0 z-30"
>
	<div class="flex flex-wrap justify-between items-center mx-auto">
		<a href="/" class="flex pl-2.5">
			...
			<span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">
				Ekisa <span class="text-[#1C64F2]">Chatbots</span>
			</span>
		</a>
		<button
